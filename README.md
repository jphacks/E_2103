...
※ __練習モードを利用するためには会員登録をして、記事を投稿する必要があります。__
...
* 実際の現場で利用し、さらに発表練習に関するUXの改善へとつなげていく
### 注力したこと
* 発表練習画面・発表練習スコアのダッシュボード等、高い効果の練習をするためのUX構築
* 発表態度のフィードバック機能
...
* `特に力を入れた部分をファイルリンク、またはcommit_idを記載してください。`
  * 特に力を入れた部分のcommit_id
    * 165428a （「発表練習画面」や「発表練習結果」の表示プロセスやシステム設計に関するもの）
      * 小中学生の「発表経験値を爆上げ！」するためのアプリなので、一番関係する発表練習画面周辺には特に力を入れました！
